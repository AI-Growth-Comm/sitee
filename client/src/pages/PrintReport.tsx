  ...
  <div class="two-col no-break" style="margin-bottom:24px;align-items:start">
    ...
    <div style="text-align:center;padding:16px 0">
      ...
      <svg width="140" height="140" viewBox="0 0 140 140" style="display:block;margin:0 auto">
        ...
        <text x="70" y="65" text-anchor="middle" font-size="26" font-weight="700" fill="#2d3748">${score}</text>
        <text x="70" y="83" text-anchor="middle" font-size="11" fill="#718096">out of 100</text>
      </svg>
      <div style="font-size:9pt;color:${scoreColor};font-weight:700;margin-top:8px">
